...
#str(svm_yhat)
#ref <- as.numeric(as.factor(svm_yhat))
#ref
#str(ref)
ref <- as.data.frame(svm_yhat)
ref
#str(test_data$IsUseful)
#as.numeric(rf_yhat3)
...
nn_fit_2 <- neuralnet(f, data = train_data, hidden = c(2,1), linear.output=TRUE) # 45- 50 mins
